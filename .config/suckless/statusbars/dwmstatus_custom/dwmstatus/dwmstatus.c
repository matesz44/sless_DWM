...
*/
        ...
        srprintf(&status, "cpu: %.0f%% | ram: %0.f%% | down: %.0f %s/s | up: %.0f %s/s",
                cpu_used/cpu_total*100, getram(), net_in, unit_in, net_out, unit_out);
